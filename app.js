...
import teacherSubjectAssignmentRouter from './router/teacherSubjectAssignment.router.js';
...
app.use('/api/v1/teacher-subject-assignments', teacherSubjectAssignmentRouter);
